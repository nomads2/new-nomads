...
public class mainComputer_C12b extends PApplet {
...
//    }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#4A3320", "--hide-stop", "mainComputer_C12b" };
    if (passedArgs != null) {
